...
import djg from '../../assets/djg.png'
import djgg from '../../assets/djgg.png'
          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://ibtc-kohl.vercel.app/marketplace" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>BTIC</h3>
              <p>
                International Business Intelligence and Tourism Company. Découvrez notre entreprise et notre marketplace
              </p>
            </div>
            <footer>
